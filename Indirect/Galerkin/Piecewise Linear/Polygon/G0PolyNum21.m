function [Int ] = G0PolyNum21(s,t,hi,hj,si,tj,bi,bj,L,sxv,syv,txv,tyv,CosEdgeAngleS,SinEdgeAngleS,CLS,CosEdgeAngleT,SinEdgeAngleT,CLT)
if si==0 && bi==L
    si=L;
end
if tj==0 && bj==L
